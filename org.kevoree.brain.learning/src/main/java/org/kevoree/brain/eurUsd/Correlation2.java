       ...
       /* Date d=new Date();
        ...
        try {
            ...
            while ((line = br.readLine()) != null) {
                ...
                Long timestamp = getTimeStamp(Integer.parseInt(dates[0]),Integer.parseInt(dates[1]),Integer.parseInt(dates[2]),Integer.parseInt(hours[0]),Integer.parseInt(hours[1]));
